...
function insertNewPost( title, text_preview, img_src, category, category_explicit, url ){
	...
	a_href = '<a id="a_href_articol" href="articol.php?title=' + title + '&text_preview=' + text_preview + '&img_src=' + img_src + '&category=' + category_explicit + '&category_explicit=' + category_explicit + '&url=' + url + '" style="color: white; text-decoration: none;">';
	document.getElementById( side + '_post_wrapper' ).innerHTML += '' +
				'<div class="' + side + '_side_post">' + 
					...
					'<div class="' + side + '_arrow_wrapper">' + 
						'<img src="' + side + '_arrow.png" class="' + side + '_arrow">' + 
						'</img>' + 
						'<img src="circle.png" class="' + side + '_circle">' + 
						'</img>' + 
					'</div>' + 
				'</div>';
	n_posts += 1;
